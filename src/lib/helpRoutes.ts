...
export const routeHelpTopics = [
  ...
  { pattern: '/admin/people', topicId: 'admin.people-directory' },
  { pattern: '/admin/people/dedupe', topicId: 'admin.people-dedupe' },
  { pattern: '/admin/people/import-year2', topicId: 'admin.people-import' },
  { pattern: '/events/:eventSlug/staff/apply', topicId: 'events.staff-application' },
  { pattern: '/admin/events/:eventId/applications', topicId: 'admin.event-applications' },
  { pattern: '/admin/events/:eventId', topicId: 'events.overview' },
  ...
  { pattern: '/admin/documents/history', topicId: 'documents.event-documents' },
